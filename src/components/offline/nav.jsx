...
export default class NavOff extends React.Component {
          ...
          <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
              <ul className="list-reset lg:flex justify-end flex-1 items-center">
                <li className="mr-3">
                  <Link className="inline-block py-2 px-4 text-black font-bold no-underline" to="/screenshots" variant="body2">
                Screenshots
               </Link>
                </li>

                <li className="mr-3">
                  <Link className="inline-block py-2 px-4 text-black font-bold no-underline" to="/login" variant="body2">
                Login
               </Link>
                </li>

              </ul>
              <Link id="navAction" to="/signup" className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-85">Start Free Trial!</Link>
            </div>
          </div>
